    ...
    <div className="min-h-screen bg-neo-bg text-white flex flex-col font-sans selection:bg-neo-neon/40 overflow-x-hidden">
      <header className="px-6 md:px-10 py-6 border-b border-white/5 bg-neo-glass/60 backdrop-blur-2xl sticky top-0 z-[100] flex items-center justify-between">
        ...
        <div className="flex gap-3 md:gap-4">
          ...
          <button onClick={handleReset} className="h-10 px-6 rounded-2xl bg-white/5 text-[10px] font-black hover:bg-white/10 transition-all flex items-center gap-2 border border-white/5 uppercase tracking-widest shadow-glass-3d active:scale-95">
            ...
            <div className="h-full relative animate-in fade-in slide-in-from-right-10 duration-700">
              ...
              {mode === 'buy' && (
                buyData ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full gap-6 text-center p-12">
                    ...
                    <h2 className="text-2xl font-black text-white uppercase tracking-tighter">No Data Available</h2>
                    <p className="text-gray-400 text-sm">Please complete the property analysis first</p>
                    <button 
                      onClick={() => setStage('chat')}
                      className="px-8 py-4 bg-neo-neon text-white rounded-2xl font-black uppercase text-xs tracking-widest shadow-neo-glow hover:scale-105 transition-all"
                    >
                      Start Analysis
                    </button>
                  </div>
              ...
              {mode === 'rent' && (
                rentData ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full gap-6 text-center p-12">
                    <div className="text-6xl">⚠️</div>
                    <h2 className="text-2xl font-black text-white uppercase tracking-tighter">No Rental Data</h2>
                    <p className="text-gray-400 text-sm">Please complete the rental analysis first</p>
                    <button 
                      onClick={() => setStage('chat')}
                      className="px-8 py-4 bg-emerald-500 text-white rounded-2xl font-black uppercase text-xs tracking-widest shadow-neo-glow hover:scale-105 transition-all"
                    >
                      Start Analysis
                    </button>
                  </div>
              ...
              {mode === 'land' && (
                landData ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full gap-6 text-center p-12">
                    <div className="text-6xl">⚠️</div>
                    <h2 className="text-2xl font-black text-white uppercase tracking-tighter">No Land Data</h2>
                    <p className="text-gray-400 text-sm">Please complete the land valuation first</p>
                    <button 
                      onClick={() => setStage('chat')}
                      className="px-8 py-4 bg-orange-500 text-white rounded-2xl font-black uppercase text-xs tracking-widest shadow-neo-glow hover:scale-105 transition-all"
                    >
                      Start Analysis
                    </button>
                  </div>
              ...
              {mode === 'commercial' && (
                commercialData ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full gap-6 text-center p-12">
                    <div className="text-6xl">⚠️</div>
                    <h2 className="text-2xl font-black text-white uppercase tracking-tighter">No Commercial Data</h2>
                    <p className="text-gray-400 text-sm">Please complete the commercial analysis first</p>
                    <button 
                      onClick={() => setStage('chat')}
                      className="px-8 py-4 bg-neo-neon text-white rounded-2xl font-black uppercase text-xs tracking-widest shadow-neo-glow hover:scale-105 transition-all"
                    >
              ...
              {showFinance && (
                <div className="fixed inset-0 z-[200] bg-neo-bg/90 backdrop-blur-2xl flex items-center justify-center p-6 animate-in fade-in zoom-in duration-300">
                  <div className="w-full max-w-5xl max-h-[90vh] bg-neo-bg border border-white/10 rounded-[64px] p-10 md:p-16 overflow-y-auto relative shadow-neo-glow border-t-white/20">
                    <button onClick={() => setShowFinance(false)} className="absolute top-10 right-10 p-4 bg-white/5 rounded-2xl hover:bg-neo-pink hover:text-white transition-all text-gray-500 shadow-glass-3d active:scale-90">
                      <X size={24}/>
                    </button>
